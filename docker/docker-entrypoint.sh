...
# in the base image, and we may be running as root rather than the mythril2 user.
sync-svm-solc-versions-with-solcx

# By default we run myth2 with options from arguments we received. But if the
