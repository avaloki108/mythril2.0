...
from mythril2.laser.ethereum.natives import ec_pair
...
@patch("mythril2.laser.ethereum.natives.bn128.is_on_curve", return_value=True)
@patch("mythril2.laser.ethereum.natives.bn128.pairing", return_value=1)
...
@patch("mythril2.laser.ethereum.natives.validate_point", return_value=False)
