...
from mythril2.laser.ethereum.state.calldata import BaseCalldata, ConcreteCalldata
from mythril2.laser.ethereum.util import extract32, extract_copy
from mythril2.support.support_utils import sha3, zpad
